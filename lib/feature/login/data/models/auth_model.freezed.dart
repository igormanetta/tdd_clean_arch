...
abstract class $AuthModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String access, String refresh, String expireIn, UserModel user});
...
class _$_AuthModel with DiagnosticableTreeMixin implements _AuthModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthModel(access: $access, refresh: $refresh, expireIn: $expireIn, user: $user)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, access, refresh, expireIn, user);
